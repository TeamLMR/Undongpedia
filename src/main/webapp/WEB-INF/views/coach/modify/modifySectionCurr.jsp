        ...
        <div class="container-fluid">
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">커리큘럼 수정하기</h1>
                </div>
                <div class="row">
                                        ...
                                        <c:if test="${not empty section.curriculums}">
                                            <c:forEach var="cur" items="${section.curriculums}">
                                                <c:if test="${cur.currSeq!=null}">
                                                    ...
                                                    <div class="row no-gutters align-items-center justify-content-between mb-3">
                                                        <div class="small badge-primary badge">${cur.currOrder+1} </div>
                                                        <div class="col-5 text-secondary d-none d-sm-block">
                                                                ${cur.currTitle}
                                                        </div>
                                                        <div class="col-3">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col">
                        <div class="form-group">
                            <%--TODO: 임시..--%>
                            <form action="${pageContext.request.contextPath}/coach/coursemanager" method="POST"
                                  class="d-flex justify-content-between" onsubmit="">
        ...
        <div class="modal fade" id="addCurriculumModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <form id="curriculumForm" action="${pageContext.request.contextPath}/coach/modifyaddcurriculum"
                          method="post"
        ...
        <script>
            ...
            const addSection = () => {
                ...
                $.ajax({
                    ...
                    success: (response) => {
                        if (response > 0) {
                            location.assign("${pageContext.request.contextPath}/coach/modifycoursesection?courseSeq=" + courseSeq);
                        } else {

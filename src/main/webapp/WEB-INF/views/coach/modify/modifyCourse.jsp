...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="container-fluid">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">코스 수정하기</h1>
                </div>
                <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <input type="text" class="form-control form-control-user"
                                                               name="courseTitle"
                                                               id="courseTitle"
                                                               placeholder="ex) 바른자세 하루 10분만 투자하세요!" value="${course.courseTitle}">
                                    ...
                                    <div class="row no-gutters align-items-center mb-3">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <input type="number" class="form-control form-control-user" min="0" max="100"
                                                               name="courseDiscount" id="courseDiscount" placeholder="할인율 입력하세요" value="${course.courseDiscount}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col pl-3 pr-3">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col">
                                                    <div class="form-group">
                                                        <c:set var="resultPrice" value="${course.coursePrice - (course.coursePrice * course.courseDiscount / 100).intValue()}"/>
                                                        <input type="number" class="form-control form-control-user" id="priceResult" placeholder="판매 가격" value="${resultPrice}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        value="${course.coursePreparation}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
            ...
            /*기존 정보 선택 세팅*/
            $('#courseCategory').val(${course.courseCategory}).prop("selected",true);
            $('#sort-select').val(${course.courseDifficult}).prop("selected",true);
